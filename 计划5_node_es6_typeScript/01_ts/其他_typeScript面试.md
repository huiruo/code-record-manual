...
const [selectUser, setSelectUser] = useState<itemObj[]>([])
...
export default (props: Props) => {
  ...
  return (
    <div pl-20 pr-20>
      <div>
        <ul row style={{ listStyle: 'none', lineHeight: '46px' }} h-46>
          <li cursorPointer mr-20 onClick={() => liClick(1)}>
            搜索添加
          </li>
          <li cursorPointer mr-20 onClick={() => liClick(2)}>
            邀请添加
          </li>
        </ul>
        {renderAddType()}
